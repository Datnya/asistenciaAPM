  ...
  return <>
    ...
    {dialog === "edit" ? <Dialog title="Editar asistencia" close={() => setDialog(null)}>
      <form action={submitEdit} className="mt-5 space-y-4">
        ...
        <label className="block text-sm font-semibold">Motivo de la corrección<textarea className="admin-field mt-1.5 min-h-22" maxLength={500} name="reason" required /></label>
